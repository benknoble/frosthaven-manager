       ...
       (details
        ...
        (table
         ...
         ,@(if (both-empty? monster-stats-bonuses)
             empty
             `((tr (td ,(monster-stats-bonuses-string normal-stats))
                   (td "Bonuses")
                   (td ,(monster-stats-bonuses-string elite-stats)))))
         ,@(if (both-empty? monster-stats-effects)
             empty
             `((tr (td ,(monster-stats-effects-string normal-stats))
                   (td "Effects")
                   (td ,(monster-stats-effects-string elite-stats)))))
         ,@(if (both-empty? monster-stats-immunities)
             empty
             `((tr (td ,(monster-stats-immunities-string normal-stats))
                   (td "Immunities")
                   (td ,(monster-stats-immunities-string elite-stats)))))
