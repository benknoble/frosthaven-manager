...
Click either the @onscreen{Open Monster DB} button or the @onscreen{Use Default
Monster DB} button. Then use the viewer below to explore and confirm the monster
information. @next
